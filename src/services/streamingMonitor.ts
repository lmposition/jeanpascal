...
import { StreamingAvailabilityService, StreamingResult } from './streamingAvailabilityService.js';
...
export class StreamingMonitor {
  ...
  private createStreamingButtons(result: StreamingResult): ActionRowBuilder<ButtonBuilder>[] {
